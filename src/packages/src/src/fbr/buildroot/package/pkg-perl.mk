...
perl-package = $(call inner-perl-package,$(call pkgname,$(1)),$(call UPPERCASE,$(call pkgname,$(1))),$(call UPPERCASE,$(call pkgname,$(1))),target)
host-perl-package = $(call inner-perl-package,host-$(call pkgname,$(1)),$(call UPPERCASE,host-$(call pkgname,$(1))),$(call UPPERCASE,$(call pkgname,$(1))),host)
