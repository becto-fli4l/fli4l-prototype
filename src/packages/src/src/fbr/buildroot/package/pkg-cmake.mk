...
cmake-package = $(call inner-cmake-package,$(call pkgname,$(1)),$(call UPPERCASE,$(call pkgname,$(1))),$(call UPPERCASE,$(call pkgname,$(1))),target)
host-cmake-package = $(call inner-cmake-package,host-$(call pkgname,$(1)),$(call UPPERCASE,host-$(call pkgname,$(1))),$(call UPPERCASE,$(call pkgname,$(1))),host)
