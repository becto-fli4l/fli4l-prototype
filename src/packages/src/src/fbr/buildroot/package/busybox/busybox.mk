...
define BUSYBOX_UPDATE_DOT_CONFIG
	$(if $(KCONFIG_FILE_DIR),
		cp -f $(BR2_PACKAGE_BUSYBOX_CONFIG) $(KCONFIG_FILE_DIR)$(BR2_PACKAGE_BUSYBOX_CONFIG))
endef
BUSYBOX_KCONFIG_POST_UPDATE_HOOKS += BUSYBOX_UPDATE_DOT_CONFIG
