...
define $(2)_INSTALL_TARGET_CMDS
	cd $$($(2)_SRCDIR) && $$(LUAROCKS_RUN_ENV) \
		$$(LUAROCKS_RUN_CMD) make --keep --tree=$$(TARGET_DIR)/usr --deps-mode=all $$($(2)_ROCKSPEC) $$($(2)_BUILD_OPTS)
endef
endif
...
$$($(2)_TARGET_EXTRACT): $$$$(HOST_LUAROCKS_TARGET_INSTALL_HOST)
...
luarocks-package = $(call inner-luarocks-package,$(call pkgname,$(1)),$(call UPPERCASE,$(call pkgname,$(1))),$(call UPPERCASE,$(call pkgname,$(1))),target)
