...
COLLECTD_CONF_ENV = ac_cv_lib_yajl_yajl_alloc=yes lt_cv_sys_dlsearch_path="/lib /usr/lib"
...
COLLECTD_PLUGINS_DISABLE = \
	...
	madwifi mbmon mic multimeter netapp notify_desktop notify_email numa \
	nut oracle perl pf pinba powerdns python redis routeros \
...
COLLECTD_CONF_OPTS += \
	...
	$(if $(BR2_PACKAGE_COLLECTD_EMAIL),--enable-email,--disable-email) \
	...
	$(if $(BR2_PACKAGE_COLLECTD_HDDTEMP),--enable-hddtemp,--disable-hddtemp) \
	...
	$(if $(BR2_PACKAGE_COLLECTD_MBMON),--enable-mbmon,--disable-mbmon) \
	...
	$(if $(BR2_PACKAGE_COLLECTD_MULTIMETER),--enable-multimeter,--disable-multimeter) \
	...
	$(if $(BR2_PACKAGE_COLLECTD_POWERDNS),--enable-powerdns,--disable-powerdns) \
	...
	$(if $(BR2_PACKAGE_COLLECTD_TEAMSPEAK2),--enable-teamspeak2,--disable-teamspeak2) \
	$(if $(BR2_PACKAGE_COLLECTD_TED),--enable-ted,--disable-ted) \
	...
	$(if $(BR2_PACKAGE_COLLECTD_UUID),--enable-uuid,--disable-uuid) \
	...
	$(if $(BR2_PACKAGE_COLLECTD_VSERVER),--enable-vserver,--disable-vserver) \
...
COLLECTD_DEPENDENCIES = \
	...
	$(if $(BR2_PACKAGE_COLLECTD_RRDCACHED),rrdtool) \
...
ifeq ($(BR2_PACKAGE_COLLECTD_DNS),y)
COLLECTD_CONF_OPTS += --with-libpcap=$(STAGING_DIR)/usr
endif
...
COLLECTD_DEPENDENCIES += luainterpreter
