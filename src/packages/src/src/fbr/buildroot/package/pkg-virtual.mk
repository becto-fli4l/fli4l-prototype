...
virtual-package = $(call inner-virtual-package,$(call pkgname,$(1)),$(call UPPERCASE,$(call pkgname,$(1))),$(call UPPERCASE,$(call pkgname,$(1))),target)
host-virtual-package = $(call inner-virtual-package,host-$(call pkgname,$(1)),$(call UPPERCASE,host-$(call pkgname,$(1))),$(call UPPERCASE,$(call pkgname,$(1))),host)
