...
# Fix build error with following message
# >>> samba4 4.7.4 Error: Library libdnsserver-common-samba4.so referenced by \
# usr/lib/python2.7/site-packages/samba/dsdb_dns.so not found
