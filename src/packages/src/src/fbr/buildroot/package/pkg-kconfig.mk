...
$(2)_KCONFIG_PRE_UPDATE_HOOKS ?=
$(2)_KCONFIG_POST_UPDATE_HOOKS ?=
...
#
$$($(2)_KCONFIG_FILE) $$($(2)_KCONFIG_FRAGMENT_FILES): | $$($(2)_TARGET_PATCH)
...
$$($(2)_DIR)/$$($(2)_KCONFIG_DOTCONFIG): | $$($(2)_TARGET_PATCH)
...
$(1)-update-config: $(1)-check-configuration-done
	...
	$$(foreach hook,$$($(2)_KCONFIG_PRE_UPDATE_HOOKS),$$(call $$(hook))$$(sep))
	cp -f $$($(2)_DIR)/$$($(2)_KCONFIG_DOTCONFIG) $$($(2)_KCONFIG_FILE)
	touch --reference $$($(2)_DIR)/$$($(2)_KCONFIG_DOTCONFIG) $$($(2)_KCONFIG_FILE)
	$$(foreach hook,$$($(2)_KCONFIG_POST_UPDATE_HOOKS),$$(call $$(hook))$$(sep))
