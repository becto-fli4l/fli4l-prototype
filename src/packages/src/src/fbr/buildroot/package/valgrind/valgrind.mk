...
VALGRIND_CONF_OPTS = \
	--disable-ubsan \
	--without-mpicc
VALGRIND_CONF_ENV = ac_cv_path_GDB="/usr/bin/gdb"
...
define VALGRIND_ADD_VALGRIND_BIN
	ln -sf valgrind $(TARGET_DIR)/usr/bin/valgrind.bin
endef
VALGRIND_POST_INSTALL_TARGET_HOOKS += VALGRIND_ADD_VALGRIND_BIN
