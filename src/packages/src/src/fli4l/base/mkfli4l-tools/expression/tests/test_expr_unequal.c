/*****************************************************************************
 *  @file test_expr_unequal.c
 *  Functions for testing inequality comparison expressions.
 *
 ...
 *
 *  Last Update: $Id: test_expr_unequal.c 44048 2016-01-15 08:03:26Z sklein $
 *****************************************************************************
 */
...
#define MU_TESTSUITE "expression.expr_unequal"

/**
 * Tests expr_kind_to_string().
 */
mu_test_begin(test_expr_unequal_kindtostring)
    mu_assert_eq_str("unequal", expr_kind_to_string(EXPR_KIND_UNEQUAL));
mu_test_end()

/**
 * Tests expr_get_type().
 */
mu_test_begin(test_expr_unequal_gettype)
    struct expr_t *arg1;
    struct expr_t *arg2;
    struct expr_t *expr;
 ...
 * Tests expr_get_kind().
 */
mu_test_begin(test_expr_unequal_getkind)
    struct expr_t *arg1;
    struct expr_t *arg2;
    struct expr_t *expr;
    ...
    expr = expr_unequal_to_expr(expr_unequal_create(var_get_global_scope(), arg1, arg2));
    mu_assert_eq_int(EXPR_KIND_UNEQUAL, expr_get_kind(expr));
    expr_destroy(expr);
 ...
 */
mu_test_begin(test_expr_unequal_getscope)
    struct expr_t *arg1;
    struct expr_t *arg2;
    struct expr_t *expr;
...
/**
 * Tests expr_unequal_get_left_arg() and expr_unequal_get_right_arg().
 */
mu_test_begin(test_expr_unequal_getarg)
    struct expr_t *arg1;
    struct expr_t *arg2;
    struct expr_unequal_t *expr;
    ...
    arg1 = expr_literal_to_expr(expr_literal_create_string(var_get_global_scope(), "Hallo"));
    arg2 = expr_literal_to_expr(expr_literal_create_integer(var_get_global_scope(), 23));
    expr = expr_unequal_create(var_get_global_scope(), arg1, arg2);
    mu_assert(expr_unequal_get_left_arg(expr) == arg1);
    mu_assert(expr_unequal_get_right_arg(expr) == arg2);
    expr_destroy(expr_unequal_to_expr(expr));
 ...
 */
mu_test_begin(test_expr_unequal_eval_string_string_eq)
    BOOL value;
    char *error_msg;
    struct expr_t *arg1;
    struct expr_t *arg2;
 ...
 */
mu_test_begin(test_expr_unequal_eval_string_string_noteq)
    BOOL value;
    char *error_msg;
    struct expr_t *arg1;
    struct expr_t *arg2;
 ...
 */
mu_test_begin(test_expr_unequal_eval_integer_integer_eq)
    BOOL value;
    char *error_msg;
    struct expr_t *arg1;
    struct expr_t *arg2;
 ...
 */
mu_test_begin(test_expr_unequal_eval_integer_integer_noteq)
    BOOL value;
    char *error_msg;
    struct expr_t *arg1;
    struct expr_t *arg2;
 ...
 */
mu_test_begin(test_expr_unequal_eval_boolean_boolean_eq)
    BOOL value;
    char *error_msg;
    struct expr_t *arg1;
    struct expr_t *arg2;
 ...
 */
mu_test_begin(test_expr_unequal_eval_boolean_boolean_noteq)
    BOOL value;
    char *error_msg;
    struct expr_t *arg1;
    struct expr_t *arg2;
 ...
 * representations.
 */
mu_test_begin(test_expr_unequal_eval_string_integer_eq)
    BOOL value;
    char *error_msg;
    struct expr_t *arg1;
    struct expr_t *arg2;
 ...
 * representations.
 */
mu_test_begin(test_expr_unequal_eval_string_integer_noteq)
    BOOL value;
    char *error_msg;
    struct expr_t *arg1;
    struct expr_t *arg2;
 ...
 * representations.
 */
mu_test_begin(test_expr_unequal_eval_integer_string_eq)
    BOOL value;
    char *error_msg;
    struct expr_t *arg1;
    struct expr_t *arg2;
 ...
 * representations.
 */
mu_test_begin(test_expr_unequal_eval_integer_string_noteq)
    BOOL value;
    char *error_msg;
    struct expr_t *arg1;
    struct expr_t *arg2;
 ...
 */
mu_test_begin(test_expr_unequal_eval_string_boolean_eq)
    BOOL value;
    char *error_msg;
    struct expr_t *arg1;
    struct expr_t *arg2;
 ...
 * string representations.
 */
mu_test_begin(test_expr_unequal_eval_string_boolean_noteq)
    BOOL value;
    char *error_msg;
    struct expr_t *arg1;
    struct expr_t *arg2;
 ...
 * string representations.
 */
mu_test_begin(test_expr_unequal_eval_boolean_string_eq)
    BOOL value;
    char *error_msg;
    struct expr_t *arg1;
    struct expr_t *arg2;
 ...
 * string representations.
 */
mu_test_begin(test_expr_unequal_eval_boolean_string_noteq)
    BOOL value;
    char *error_msg;
    struct expr_t *arg1;
    struct expr_t *arg2;
 ...
 */
mu_test_begin(test_expr_unequal_eval_integer_boolean)
    struct expr_t *arg1;
    struct expr_t *arg2;
    struct expr_t *expr;
    struct expr_t *error_expr;
 ...
 */
mu_test_begin(test_expr_unequal_eval_boolean_integer)
    struct expr_t *arg1;
    struct expr_t *arg2;
    struct expr_t *expr;
    struct expr_t *error_expr;
 ...
 */
mu_test_begin(test_expr_unequal_eval_error_string)
    BOOL value;
    char *error_msg = NULL;
    struct expr_t *arg1;
    struct expr_t *arg2;
 ...
 */
mu_test_begin(test_expr_unequal_eval_string_error)
    BOOL value;
    char *error_msg = NULL;
    struct expr_t *arg1;
    struct expr_t *arg2;
 ...
 */
mu_test_begin(test_expr_unequal_eval_error_integer)
    BOOL value;
    char *error_msg = NULL;
    struct expr_t *arg1;
    struct expr_t *arg2;
 ...
 */
mu_test_begin(test_expr_unequal_eval_integer_error)
    BOOL value;
    char *error_msg = NULL;
    struct expr_t *arg1;
    struct expr_t *arg2;
 ...
 */
mu_test_begin(test_expr_unequal_eval_error_boolean)
    BOOL value;
    char *error_msg = NULL;
    struct expr_t *arg1;
    struct expr_t *arg2;
 ...
 */
mu_test_begin(test_expr_unequal_eval_boolean_error)
    BOOL value;
    char *error_msg = NULL;
    struct expr_t *arg1;
    struct expr_t *arg2;
 ...
 */
mu_test_begin(test_expr_unequal_tostring)
    struct expr_t *arg1;
    struct expr_t *arg2;
    struct expr_t *expr;
    char *value;
...
/**
 * Tests equal() on two equal inequality comparison expressions.
 */
mu_test_begin(test_expr_unequal_equal1)
    struct expr_t *expr1;
    struct expr_t *expr2;
    ...
    expr1 = expr_unequal_to_expr(expr_unequal_create(
    ...
    expr2 = expr_unequal_to_expr(expr_unequal_create(
        var_get_global_scope(),
        expr_literal_to_expr(expr_literal_create_boolean(var_get_global_scope(), TRUE)),
        expr_literal_to_expr(expr_literal_create_boolean(var_get_global_scope(), FALSE))
    ));
...
/**
 * Tests equal() on two unequal inequality comparison expressions (1).
 */
mu_test_begin(test_expr_unequal_equal2)
    struct expr_t *expr1;
    struct expr_t *expr2;
...
/**
 * Tests equal() on two unequal inequality comparison expressions (2).
 */
mu_test_begin(test_expr_unequal_equal3)
    struct expr_t *expr1;
    struct expr_t *expr2;
 ...
 */
mu_test_begin(test_expr_unequal_clone)
    struct expr_t *expr1;
    struct expr_t *expr2;
...
void
test_expr_unequal(void)
{
    mu_run_test(test_expr_unequal_kindtostring);
    mu_run_test(test_expr_unequal_gettype);
    mu_run_test(test_expr_unequal_getkind);
    mu_run_test(test_expr_unequal_getscope);
    mu_run_test(test_expr_unequal_getarg);
    mu_run_test(test_expr_unequal_eval_string_string_eq);
    mu_run_test(test_expr_unequal_eval_string_string_noteq);
    mu_run_test(test_expr_unequal_eval_integer_integer_eq);
    mu_run_test(test_expr_unequal_eval_integer_integer_noteq);
    mu_run_test(test_expr_unequal_eval_boolean_boolean_eq);
    mu_run_test(test_expr_unequal_eval_boolean_boolean_noteq);
    mu_run_test(test_expr_unequal_eval_string_integer_eq);
    mu_run_test(test_expr_unequal_eval_string_integer_noteq);
    mu_run_test(test_expr_unequal_eval_integer_string_eq);
    mu_run_test(test_expr_unequal_eval_integer_string_noteq);
    mu_run_test(test_expr_unequal_eval_string_boolean_eq);
    mu_run_test(test_expr_unequal_eval_string_boolean_noteq);
    mu_run_test(test_expr_unequal_eval_boolean_string_eq);
    mu_run_test(test_expr_unequal_eval_boolean_string_noteq);
    mu_run_test(test_expr_unequal_eval_integer_boolean);
    mu_run_test(test_expr_unequal_eval_boolean_integer);
    mu_run_test(test_expr_unequal_eval_error_string);
    mu_run_test(test_expr_unequal_eval_string_error);
    mu_run_test(test_expr_unequal_eval_error_integer);
    mu_run_test(test_expr_unequal_eval_integer_error);
    mu_run_test(test_expr_unequal_eval_error_boolean);
    mu_run_test(test_expr_unequal_eval_boolean_error);
    mu_run_test(test_expr_unequal_tostring);
    mu_run_test(test_expr_unequal_equal1);
    mu_run_test(test_expr_unequal_equal2);
    mu_run_test(test_expr_unequal_equal3);
    mu_run_test(test_expr_unequal_clone);
}
