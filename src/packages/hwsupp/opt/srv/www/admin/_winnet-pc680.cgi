#!/bin/sh
# $Id: _winnet-pc680.cgi 51847 2018-03-06 14:55:07Z kristov $
...
show_html_header "WinNet PC680"

if [ -e /srv/www/include/rrd-common.inc ]
then
    . /srv/www/include/rrd-common.inc
    if [ -e /srv/www/include/rrd-winnet-pc680.inc ]
    then
     . /srv/www/include/rrd-winnet-pc680.inc
    fi
fi
if [ -e /srv/www/include/hwmon-winnet-pc680.inc ]
then
    . /srv/www/include/hwmon-winnet-pc680.inc
fi
...
: ${FORM_action:=winnet_pc680_temp}
if [ -e /srv/www/include/rrd-common.inc ]
then
    : ${FORM_rrd_graphtime_winnet_pc680_temp:=$rrd_default_graphtime}
    : ${FORM_rrd_graphtime_winnet_pc680_voltage:=$rrd_default_graphtime}
    : ${FORM_rrd_graphtime_winnet_pc680_frequency:=$rrd_default_graphtime}
...
do
    ...
    if [ "$FORM_action" = "winnet_pc680_$i" ]
    then
        tab_list=`echo "$tab_list $label no"`
    else
        tab_list=`echo "$tab_list $label $myname?action=winnet_pc680_$i"`
    fi
done
