#!/bin/sh
# $Id: _soekris-net4801.cgi 51847 2018-03-06 14:55:07Z kristov $
...
then
    ...
    if [ -e /srv/www/include/rrd-soekris-net4801.inc ]
    then
     . /srv/www/include/rrd-soekris-net4801.inc
    fi
fi
if [ -e /srv/www/include/hwmon-soekris-net4801.inc ]
then
    . /srv/www/include/hwmon-soekris-net4801.inc
fi
...
: ${FORM_action:=soekris_net4801_temp}
if [ -e /srv/www/include/rrd-common.inc ]
then
    : ${FORM_rrd_graphtime_soekris_net4801_temp:=$rrd_default_graphtime}
    : ${FORM_rrd_graphtime_soekris_net4801_voltage:=$rrd_default_graphtime}
...
do
    ...
    if [ "$FORM_action" = "soekris_net4801_$i" ]
    then
        tab_list=`echo "$tab_list $label no"`
    else
        tab_list=`echo "$tab_list $label $myname?action=soekris_net4801_$i"`
    fi
done

show_tab_header $tab_list
case $FORM_action in
    soekris_net4801_hwmon)
        hwmon_soekris_net4801
    ;;
    soekris_net4801_bios)
        extra_dmidecode
    ;;
    *)
