#!/bin/sh
# $Id: _generic-acpi-coretemp.cgi 51847 2018-03-06 14:55:07Z kristov $
...
show_html_header "Hardware-Support: GENERIC-ACPI (coretemp)"

if [ -e /srv/www/include/rrd-common.inc ]
then
    . /srv/www/include/rrd-common.inc
    if [ -e /srv/www/include/rrd-generic-acpi-coretemp.inc ]
    then
     . /srv/www/include/rrd-generic-acpi-coretemp.inc
    fi
fi
if [ -e /srv/www/include/hwmon-generic-acpi-coretemp.inc ]
then
